...
class IMDBFav_TVShowssAdapter(
    private val mContext: Context,
    internal var mImdbList: List<ImdbFavModel>
) :
    RecyclerView.Adapter<IMDBFav_TVShowssAdapter.SubItemViewHolder>() {
    ...
    override fun onBindViewHolder(itemViewHolder: SubItemViewHolder, position: Int) {
        val mFavMoviesList = mImdbList[position]
            ...
            getTVShowsByID(mFavMoviesList.id, itemViewHolder)
        ...
        itemViewHolder.tvDelete.setOnClickListener(View.OnClickListener {
            ...
            val jo = JSONObject()
            jo.put("favTvShows", mFavMoviesList.id)
    ...
    private fun getTVShowsByID(movieID: String, view: SubItemViewHolder) {

        Constants.Imdb_service.geTVShowsFromId(movieID.toLong(), Constants.API_Key, "en-US")
            .enqueue(object :
                ...
                override fun onResponse(
                    ...
                    try {
                        ...
                        val mMoviePoster = jsonobj.getString("backdrop_path")
